        ...
        >
          <Form className='agreementWrapperForm'>
            ...
            <div className="formWrapper receiver">
              <label htmlFor="receiver">We <strong>Zavtra Bank</strong> represented by <br/><strong>Mr/Ms/Mrs</strong></label>
              <Field
                id='receiver'
                type='text'
                name='receiver'
            ...
            <div className="formWrapper donor">
              <label htmlFor="donor"> from <strong>Mr/Ms/Mrs</strong></label>
              <Field
                id='donor'
                type='text'
                name='donor'
            ...
            <div className="formWrapper depositAccount">
              ...
              <ErrorMessage 
                ...
                name='depositAccount'
              />
              <label htmlFor="depositAccount">At <strong>Zavtra Bank.</strong></label>
            </div>
            ...
            <div className="applySecurityWrapper apply">
              <div className="applyManager">
                <p className="applyText">Management agrees that this Security deposit will be returned in full if all the conditions listed below have been met.</p>
                <div className="applyName">Manager</div>
              </div>
              <div className="applyManager">
                <p className="applyText">The clients agrees not to apply the security deposit as a share and (2) that  the full monthly interest rate will be paid by the Bank in between the first 5 days of each semester.</p>
                <div className="applyName">Client</div>
              </div>
            </div>

            <div className="noticeWrapper notice">
              <h2 className="noticeTitle">THE BANK WILL RETURN THE DEPOSIT IF:</h2>
              ...
              <span className="notes"><span className='adressBold'>Notes: </span>The client and the bank management in case of any dispute or misunderstanding can take any legal measure to insure the respect of this deposit agreement.</span>
            </div>

            <div className="btnContainer">
              <button type='submit' className='btn formBtn'>Consulter en PDF</button>
              <button onClick={() => downloadPdf(<PdfTemplate />, "formulaire")} className='btn' type='button'>telecharger en PDF</button>
            </div>
          </Form>
        </Formik>
